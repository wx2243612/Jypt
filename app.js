...
const bodyParser = require('body-parser');//中间件/可从request中获取body数据
...
//监听Http请求  XXX端口的信息数据
mongoose.connect('mongodb://localhost:27017/jypt', function (err) {
//镜像启动路径
//mongoose.connect('mongodb://mongodb/jypt', function (err) {
    if (err) {
        console.log('数据库连接失败');
        return;
    }
        ...
        console.log('数据库连接成功');
        app.listen(7770, 'localhost');
        console.log('Server is running at http://localhost:7770');
    }
});
